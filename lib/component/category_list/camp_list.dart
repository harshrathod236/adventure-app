                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => DetailScreen(
                                  ...
                                  name: "${categoryList[index]["CampPlaceName"]}",
                                  locationName: "${categoryList[index]["CamplocationName"]}",
                                  url: '${categoryList[index]["CampUrl"]}',
                                ),
                              ),
                            );
                          },
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage("${categoryList[index]["CampUrl"]}"),
                                ),
                                color: Colors.white,
                                borderRadius: BorderRadius.circular(15)),
                          ),
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "${categoryList[index]["CampPlaceName"]}",
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "${categoryList[index]["CamplocationName"]}",
