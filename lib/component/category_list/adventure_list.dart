...
class AdventureCategoryList extends StatelessWidget {
  const AdventureCategoryList({
    Key? key,
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => DetailScreen(
                                  ...
                                  name: "${categoryList[index]["PlaceName"]}",
                                  locationName: "${categoryList[index]["locationName"]}",
                                  url: '${categoryList[index]["AdventureUrl"]}',
                                ),
                              ),
                            );
                          },
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage("${categoryList[index]["AdventureUrl"]}"),
                              ),
                              color: Colors.white,
                              borderRadius: BorderRadius.circular(15),
                            ),
