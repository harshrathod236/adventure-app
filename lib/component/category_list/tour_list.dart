                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => DetailScreen(
                                  ...
                                  name: "${categoryList[index]["TourPlaceName"]}",
                                  locationName: "${categoryList[index]["TourlocationName"]}",
                                  url: '${categoryList[index]["TourUrl"]}',
                                ),
                              ),
                            );
                          },
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage("${categoryList[index]["TourUrl"]}"),
                                ),
                                color: Colors.white,
                                borderRadius: BorderRadius.circular(15)),
                          ),
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "${categoryList[index]["TourPlaceName"]}",
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "${categoryList[index]["TourlocationName"]}",
